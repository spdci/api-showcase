...
import io.swagger.model.InlineResponse401Error;
...
/**
 * HTTP transport layer error codes. Used by components like gateways, LB responding with HTTP status codes 1xx, 2xx, 3xx, 4xx and 5xx
 */
